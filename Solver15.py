        ...
        if isGoal(currentState.board):
            ...
            for (board,move) in successorBoard(currentState.board):
                ...
                if str(state.board) not in visited:
                    ...
                    elif h == 'hManhattanDistance':
                        heappush(pq,(state.currentCost + state.hManhattanDistance(),state))
                    elif h == 'hReverse':
                        heappush(pq,(state.currentCost + state.hReverse(),state))
...
=======
>>>>>>> c8f2ba193d9e024b834bb2837ca4b5efb827cb76
####### Run the Program #########
import sys
arguments = sys.argv
